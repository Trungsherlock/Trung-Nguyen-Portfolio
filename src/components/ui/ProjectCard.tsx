...
export function ProjectCard({
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-blue-500 via-purple-500 to-blue-500 rounded-xl blur-xl opacity-30 group-hover:opacity-60 pointer-events-none" />
      ...
      <div className="relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg overflow-hidden group hover:shadow-xl transition-transform duration-300">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
            ...
            {/* GitHub Link */}
            <a
              href={`https://github.com/Trungsherlock/${title.toLowerCase()}`}
              target="_blank"
              rel="noopener noreferrer"
