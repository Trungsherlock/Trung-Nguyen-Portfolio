      ...
      <div className="container mx-auto max-w-6xl px-8">
        ...
        <div className="mb-12 flex flex-col items-center">
          ...
          <p className="mt-8 text-lg text-center text-gray-600 dark:text-gray-300 max-w-5xl">
            My GitHub contributions reflect my consistent commitment to
            open-source development and personal projects. Explore my
            repositories to learn more about the projects I've worked on and the
